window.addEventListener("load", () => {
    ...
    .then(function (jsonObject) {
        ...
        for (var i = 0; i < towns[2].events.length; i++){
            ...
            event.textContent = towns[2].events[i];
    ...
    //Preston API
    const apiURL = 'https://api.openweathermap.org/data/2.5/weather?id=5585010&appid=70a3382c326cf2cbb5e5cc5922554860&units=imperial';
    fetch(apiURL)
    ...
    const apiURL2 = 'https://api.openweathermap.org/data/2.5/forecast?id=5585010&appid=70a3382c326cf2cbb5e5cc5922554860&units=imperial'
    fetch(apiURL2)
    .then((response) => response.json())
    .then((jsObject) => {
        console.log(jsObject);
